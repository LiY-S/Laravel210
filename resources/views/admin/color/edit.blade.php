...
<div class="col-md-6" style="float: none">
    <div class="content-box">
        ...
        <div class="content">
            <form class="form-horizontal" action="/admins/colors/update/{{$color->id}}" method="post"  enctype='multipart/form-data' name="upfile"  id="art_form">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="inputPassword3" name="color" value="{{$color->color}}">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        <input type="file" name="photo[]" multiple style="margin-top: 10px" id="file_upload">
                            <img src="{{$color->photo['0']}}" alt="" width="80" id="imgs0">
                            <img src="{{$color->photo['1']}}" alt="" width="80" id="imgs1">
                            <img src="{{$color->photo['2']}}" alt="" width="80" id="imgs2">
                    </div>
                </div>
                <div class="form-group" style="margin-top:30px">
                    <div class="">
                		{{csrf_field()}}
                        <input id="sub" type="submit" class="btn-info col-sm-3 col-sm-offset-5" style="border: 0px;border-radius:5px;height: 50px" value="修改">
                    </div>
                </div>
            </form>
        </div>
