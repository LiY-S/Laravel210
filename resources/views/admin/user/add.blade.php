                    ...
                    <div class="content-box">
                        ...
                        <div class="content">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control input-info" name="username">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control input-info" name="password">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control input-info" name="repass">
                            </div>
                            ...
                            <div class="content-box">
                                ...
                                <div class="content border:1px">
                                    <input type="file" class="dropify" data-max-file-size="1M" name="profile">
                                </div>
                            </div>
